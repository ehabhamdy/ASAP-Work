 ...
 */
public class FragmentWorkerSignUp extends Fragment {
    /**
     ...
     * number.
     */
    public static FragmentWorkerSignUp newInstance(int sectionNumber) {
        FragmentWorkerSignUp fragment = new FragmentWorkerSignUp();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_worker_signup, container, false);
...
//
    ...
    private void onAuthSuccess(FirebaseUser user, String username, String phone, String location, String craft, String ssn) {
        ...
        // Go to MainActivity
        Intent intent = new Intent(getActivity(), ActivityWorkerMain.class);
